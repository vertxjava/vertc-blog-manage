    ...
    export default {
        ...
        mounted: function() {
            ...
            this.$nextTick(function() {
                this.$http.get('http://www.vertxjava.com/api/manage/category/all').then(response => {
            ...
            this.$nextTick(function() {
                ...
                this.$http.get('http://www.vertxjava.com/api/manage/article/findByid?id='+this.$route.query.id).then(response => {
        ...
        methods: {
            handleSubmit(name) {
                ...
                this.$http.post('http://www.vertxjava.com/api/manage/article/update',this.formItem).then(response => {
